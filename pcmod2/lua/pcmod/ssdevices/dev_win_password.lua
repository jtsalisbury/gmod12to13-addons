...
DEV.Name = "window_password"

DEV.LastTick = 0
DEV.LastFrame = 0

DEV.Text = { "Welcome to the Personal OS.", "Please enter your password to continue." }
...
function DEV:Paint( x, y, w, h )
	...
	self:RenderWindow( self.Th, x+(w*0.1), y+(h*0.1), w*0.8, h*0.8, "Personal OS - Password Entry", h*0.04 )
