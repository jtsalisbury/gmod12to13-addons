...
THEME.ButtonCol = {
	UpperOuter = Color( 200, 200, 200, 255 ),
	LowerOuter = Color( 50, 50, 50, 255 ),
	UpperMid = Color( 150, 150, 150, 255 ),
	LowerMid = Color( 100, 100, 100, 255 ),
	BG = Color( 120, 120, 120, 255 ),
	Text = Color( 0, 0, 0, 255 ),
	Outline = Color( 0, 0, 0, 255 )
}

THEME.ListboxCol = {
	LowerOuter = Color( 200, 200, 200, 255 ),
	UpperOuter = Color( 50, 50, 50, 255 ),
	LowerMid = Color( 150, 150, 150, 255 ),
