...
if (CLIENT) then
	...
	SWEP.DrawCrosshair	= true		-- Should we draw the half life 2 crosshair?
...
SWEP.Category			= "G.G.U.N.S"		-- Swep Categorie (You can type what your want)

SWEP.DrawWeaponInfoBox  	= true					-- Should we draw a weapon info when you're selecting your swep?

SWEP.Author 			= "GRIBA, Silenced dude, Hiyougami, Zacmeeks"				-- Author Name
